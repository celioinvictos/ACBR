...
//        AEspecieTitulo := '99'
     ...
     if (ACBrTitulo.CarteiraEnvio = tceCedente) then
      ...
      Result:= IntToStrZero(ACBrBanco.Numero, 3)                             + //1 a 3 - C�digo do banco
               '0001'                                                        + //4 a 7 - Lote de servi�o
               '3'                                                           +
               IntToStrZero((FNumeroSequencialRegistroNoLote)+ 1 ,5)                                       + //9 a 13 - N�mero seq�encial do registro no lote - Cada registro possui dois segmentos
      ...
      Result:= Result + #13#10 +
              ...
              //   PadLeft('0', 8, '0')                                      + // 200-207 C�digo oco. sacado "0000000"
...
begin
  ...
  Result:= IntToStrZero(ACBrBanco.Numero, 3)                          + //C�digo do banco
           ...
           IntToStrZero( round( fpValorTotalDocs * 100), 17)          + //Valor dos t�tulos em cobran�a simples
