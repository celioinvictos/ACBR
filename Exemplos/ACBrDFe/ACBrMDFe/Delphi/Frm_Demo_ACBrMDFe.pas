  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // Informa��es das Unidades de Transporte (Carreta/Reboque/Vag�o)
        ...
        begin
          ...
          idUnidTransp := 'ABC1234'; // informar a placa se rodovi�rio
          ...
          // Informa��es das Unidades de carga (Containeres/ULD/Outros)
...
begin
  ...
  if not(InputQuery('WebServices Enviar', 'N�mero do Protocolo', vProtocolo)) then
    exit;

  if not(InputQuery('WebServices Enviar', 'Estado de Encerramento', vUF)) then
    exit;

  if not(InputQuery('WebServices Enviar', 'C�d. Munic�pio IBGE de Encerramento', vCodMun)) then
    exit;
